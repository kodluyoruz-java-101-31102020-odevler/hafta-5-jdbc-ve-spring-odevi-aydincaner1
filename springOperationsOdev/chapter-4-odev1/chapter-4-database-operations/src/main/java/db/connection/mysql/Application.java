...
public class Application {
	...
	public static void listActiveManagers(ManagerService managerService) {
		...
		List<Manager> activeManagerList = managerService.getActiveManager();
		for (Manager manager : activeManagerList) {
			System.out.println(manager.getEmployee().getName());
		}
	...
	public static void listDepartments(DepartmentService departmentService) {
		...
		List<Department> debtlist = departmentService.getAll();
		for (Department debt : debtlist) {
